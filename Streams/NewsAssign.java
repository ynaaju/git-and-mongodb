...
public class NewsAssign {
    ...
    public static void main(String args[])
    {
        ...
        News news1 = new News(1, "Naaju", "naaz", "comment");
        News news2 =new News(2, "Naaju1", "naaz1", "budget");
        News news3 = new News(1, "Naaju2", "naaz2", "comment");
        News news4 = new News(3, "Naaju3", "naaz3", "budget");
        News news5 = new News(1, "Naaju4", "naaz4", "comment");
        News news6 = new News(3, "Naaju5", "naaz5", "budget");
        News news7 = new News(1, "Naaju6", "naaz6" ,"comment");
